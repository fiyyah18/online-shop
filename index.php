...
<body>
  ...
  <a class="navbar-brand" href="#">Afinzas</a>
    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          ...
          <a class="dropdown-item" href="#">Konsumen</a>
          ...
          <div class="row">
            ...
            <div class="span4">
                <div class="icons-box">
                        ...
                        <img src="img/barang/<?php echo $data['foto']; ?>" height="150px" weight="50px" />
...
<!---->
      ...
      <div class="row">
                  <?php
                  include "koneksi/koneksi.php";
                    $sql = mysqli_query($koneksi, "SELECT * FROM iklan ORDER BY id DESC limit 9");
                    while($data = mysqli_fetch_array($sql)){
                    ?>
            <div class="span4">
                <div class="icons-box">
                        <img src="img/iklan/<?php echo $data['iklan']; ?>" height="100px" weight="50px" />          
                    </div>
            </div>
                <?php   
              }
